...
static int smb_parse_dt(struct smbchg_chip *chip)
{
	...
	/* read the bms battery type name */
	rc = of_property_read_string(node, "qcom,bms-battery-type",
			&chip->bms_batt_type);
	if (rc)
		chip->bms_batt_type = NULL;
